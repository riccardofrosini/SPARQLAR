...
public class Application {
    ...
    public static void main(String[] args) throws OptimisationSchemaException, ParseException, CostException, OntologyException, OptimisationContainmentException {
        //new MainWindow();
    ...
    private static void yagoRun(Approximating approximating) throws CostException, OntologyException, OptimisationSchemaException, ParseException, OptimisationContainmentException {
        ...
        for (String yagoQuery : oldYagoQueries) {
